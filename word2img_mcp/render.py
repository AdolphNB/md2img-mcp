...
<body>
    ...
    def _generate_css(self, options: RenderOptions) -> str:
        """生成CSS样式"""
        bg_color = f"rgb({options.background[0]}, {options.background[1]}, {options.background[2]})"
        text_color = f"rgb({options.text_color[0]}, {options.text_color[1]}, {options.text_color[2]})"
        accent_color = f"rgb({options.accent_color[0]}, {options.accent_color[1]}, {options.accent_color[2]})"
